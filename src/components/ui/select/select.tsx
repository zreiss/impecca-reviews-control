    ...
    return (
      <>
        <HeadlessSelect.Popover
          {...props}
          class={cn(
            "bg-popover text-popover-foreground data-closing:animate-out data-closing:fade-out-0 data-closing:zoom-out-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 w-full max-w-60 min-w-32 rounded-md border p-1 shadow-md",
            props.class,
          )}
        >
          <Slot />
